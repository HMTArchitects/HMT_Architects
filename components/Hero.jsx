    ...
    <div className="bg-white">
      <div className="lg:m-22 md:pl-14 m-8 flex flex-row pb-16">
        <div className="flex lg:basis-1/2 md:basis-2/3 ">
          <div>
            <h1 className="lg:text-7xl text-6xl  font-bold pl-8 pb-4 pt-8 md:pt-20">
              WE DESIGN
            </h1>
            <Typed
              className="text-black lg:text-7xl  text-6xl font-bold pl-8 "
              strings={["HOMES", "OFFICES", "INTERIOR"]}
              typeSpeed={180}
              backSpeed={180}
              loop
            />
