'use client'
import { data } from "../../../constants/farm_house_devaneri.js";
import { Footer } from "@/components";
import Image from "next/image";
import React, { useState } from "react";
import logo from "../../../assets/cancel.png";

export default function farm_house_devaneri() {
        ...
        <div className="flex md:flex-row flex-col mt-10">
          <div className="md:w-1/3 mt-10 ml-20 flex flex-col">
            ...
            <div>
              ...
              <p>
              The farm house is located in Sholavaram, chennai. It is a Weekend stay space and has been designed
in the most premium way. The Outdoor spaces are designed using the levels and contours in site.              </p>
            </div>
          </div>
