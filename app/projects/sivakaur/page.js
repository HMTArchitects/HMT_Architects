'use client'
import { data } from "../../../constants/siva_karur.js";
import { Footer } from "@/components";
import Image from "next/image";
import React, { useState } from "react";
import logo from "../../../assets/cancel.png";

export default function siva_karur() {
        ...
        <div className="flex md:flex-row flex-col mt-10">
          <div className="md:w-1/3 mt-10 ml-20 flex flex-col">
            ...
            <div>
              ...
              <p>
              The residence is located in Karur. It is a Contemporary villa designed for an engineer. 
The Residence has office in the ground floor and an individual duplex house in the upper floors.
The Duplex has integrated spaces between the floors.
              </p>
            </div>
          </div>
      ...
      <div class="flex items-center justify-center py-8">
        <a
          href="../projects/srinivasankaranodai"
