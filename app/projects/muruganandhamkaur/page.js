'use client'
import { data } from "../../../constants/muruganandham_karur.js";
        ...
        <div className="flex md:flex-row flex-col mt-10">
          <div className="md:w-1/3 mt-10 ml-20 flex flex-col">
            ...
            <div>
              ...
              <p>
              The residence is located in Karur. It is a design that has been done using vastu and all the properties of natural stone.
              </p>
            </div>
          </div>
