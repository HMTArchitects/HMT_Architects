'use client'
import { data } from "../../../constants/srinivasan_karanodai.js";
import { Footer } from "@/components";
import Image from "next/image";
import React, { useState } from "react";
import logo from "../../../assets/cancel.png";

export default function srinivasan_karanodai() {
        ...
        <div className="flex md:flex-row flex-col mt-10">
          <div className="md:w-1/3 mt-10 ml-20 flex flex-col">
            ...
            <div>
              ...
              <p>
              The villa is located in Redhills, chennai. It is a high end individual house and has been designed
in the most premium way. All the elements of design have been customised as per clients needs.
              </p>
            </div>
          </div>
