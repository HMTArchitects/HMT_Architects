'use client'
import { data } from "../../../constants/karthika_dindigul.js";
import { Footer } from "@/components";
import Image from "next/image";
import React, { useState } from "react";
import logo from "../../../assets/cancel.png";

export default function karthika_dindigul() {
        ...
        <div className="flex md:flex-row flex-col mt-10">
          <div className="md:w-1/3 mt-10 ml-20 flex flex-col">
            <div>
              ...
              <p>Architecture, Interiors, Electrical & Plumbing</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
              The residence is located in Dindigul. It is a Symbol for contemporary design.
The design is a minimalist one with limited usage of materials and colours. Double Height Spaces and integration of outdoor with
indoor has been an important element of design.
              </p>
            </div>
          </div>
